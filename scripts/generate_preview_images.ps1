...
function Build-SitePreview([string]$path) {
    ...
    Write-Text -g $g -text (U "0JLQuNGC0YDQuNC90LAg0LrQsNGA0YLQvtGH0LXQuiDQvNC+0LTRg9C70LXQuSBTVFc=") -fontName "Segoe UI" -size 18 -style "Regular" -color "#95a7ba" -x 110 -y 158

    Draw-RoundedRect $g (New-Brush "#1c2a3d") (New-Pen "#2b425c" 1) 110 220 420 240 20
    Write-Text -g $g -text (U "0JzQvtC00YPQu9C4") -fontName "Segoe UI" -size 18 -style "Bold" -color "#5eb8ff" -x 140 -y 250
    Write-Text -g $g -text (U "MDEg0YjRgi4=") -fontName "Segoe UI" -size 28 -style "Bold" -color "#eef4fb" -x 140 -y 290
    Write-Text -g $g -text (U "0KHRgtCw0LfQuNGBLdGP0LrQvtGA0Yw=") -fontName "Segoe UI" -size 17 -style "Regular" -color "#95a7ba" -x 140 -y 345
    Write-Text -g $g -text (U "0J7RgtC60YDQvtC60YDRi9GC0Ywg0LrQsNGA0YLQvtGH0LrRgw==") -fontName "Segoe UI" -size 17 -style "Regular" -color "#95a7ba" -x 140 -y 375
    ...
    Write-Text -g $g -text (U "0JjQvdGC0LXRgNCw0LrRgtC40LLQvdCw0Y8g0LrQsNGA0YLQvtGH0LrQsCDQsNC90YLQuC3Rg9C60LvQvtC90LXQvdC40Y8=") -fontName "Segoe UI" -size 18 -style "Regular" -color "#95a7ba" -x 640 -y 338
    Write-Text -g $g -text (U "0YPRgNC+0LLQvdC4IEwxLUw5LCAvcGluINC4INGI0LDQvdGBINC/0L7Qv9Cw0LTQsNC90LjRjw==") -fontName "Segoe UI" -size 17 -style "Regular" -color "#95a7ba" -x 640 -y 372
    Draw-RoundedRect $g (New-Brush "#152538") (New-Pen "#244e76" 1) 640 412 250 34 17
    Write-Text -g $g -text (U "0J7RgtC60YDQvtC5INC60LDRgNGC0L7Rh9C60YM=") -fontName "Segoe UI" -size 14 -style "Bold" -color "#63b6ff" -x 660 -y 419
...
function Build-StasisPreview([string]$path) {
    ...
    Write-Text -g $g -text (U "0JjQvdGC0LXRgNCw0LrRgtC40LLQvdCw0Y8g0LrQsNGA0YLQvtGH0LrQsCDQvNC+0LTRg9C70Y8=") -fontName "Segoe UI" -size 22 -style "Regular" -color "#91a3b7" -x 110 -y 248
    Write-Text -g $g -text (U "0JPQu9Cw0LLQvdGL0Lkg0LDQutGG0LXQvdGCOiDRiNCw0L3RgSDQv9C+0L/QsNC00LDQvdC40Y8=") -fontName "Segoe UI" -size 24 -style "Regular" -color "#eef4fb" -x 110 -y 320
    Write-Text -g $g -text (U "L3BpbiDRg9GB0LjQu9C40LLQsNC10YIg0LTQtdCx0LDRhNGEINC/0LXRgNC10LQg0LHQvtC10Lw=") -fontName "Segoe UI" -size 24 -style "Bold" -color "#5eb8ff" -x 110 -y 360
    Write-Text -g $g -text (U "TDEtTDkgIOKAoiAgZG9kZ2Ug0LLRgNCw0LPQsCAg4oCiICDRiNCw0L3RgSDQv9C+0L/QsNC00LDQvdC40Y8=") -fontName "Segoe UI" -size 20 -style "Regular" -color "#91a3b7" -x 110 -y 424
    ...
    Write-Text -g $g -text (U "0KjQsNC90YEg0L/QvtC/0LDQtNCw0L3QuNGP") -fontName "Segoe UI" -size 18 -style "Regular" -color "#91a3b7" -x 770 -y 320
    Write-Text -g $g -text (U "OTgl") -fontName "Segoe UI" -size 56 -style "Bold" -color "#63d3a7" -x 770 -y 350

    Draw-RoundedRect $g (New-Brush "#18273a") (New-Pen "#396187" 1) 740 448 290 46 18
    Write-Text -g $g -text (U "0KHRgNCw0LfRgyDQstC40LTQvdC+INCz0LvQsNCy0L3Ri9C5INC40YLQvtCz") -fontName "Segoe UI" -size 15 -style "Bold" -color "#bfe0ff" -x 760 -y 462
